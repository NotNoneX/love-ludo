...
如果需要在线玩的可以用这个版本，但是部署啊什么的太麻烦了，还是推荐用https://github.com/woniu9524/couple-flying-chess这个版本

## 在线体验

- 访问地址：https://cpfly.top/  (这个是本地版本，在线版本的不提供在线预览了，vercel免费版撑不住，然后其实在线的国外服务器也比较卡，本地版现在提供和在线版一样的功能，只是需要两个人一个手机)
